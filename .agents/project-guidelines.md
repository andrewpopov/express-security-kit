# express-security-kit project guidelines

Dependency-light Express security library. Owns the machinery (helmet preset, rate limiter); consuming services inject all policy.
