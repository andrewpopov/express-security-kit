...
export interface ApiKeyAuthConfig {
     ...
     */
    onAuthenticated?: (req: Request, key: ApiKeyRecord) => SecurityContext | Promise<SecurityContext>;
    /**
     ...
     */
    onFailure?: (req: Request, reason: ApiKeyFailureReason) => void | Promise<unknown>;
    /**
