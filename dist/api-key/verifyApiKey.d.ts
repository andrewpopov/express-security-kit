...
import { ApiKeyAuthConfig, ApiKeyFailureReason, ApiKeyRecord } from './types';
/**
 ...
 */
export declare function extractRawKey(req: Request, headerName: string): ExtractResult;
 ...
 */
export declare function verifyApiKey(config: ApiKeyAuthConfig, req: Request): Promise<ApiKeyVerifyOutcome>;
export {};
