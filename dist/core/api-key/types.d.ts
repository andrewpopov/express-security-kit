 ...
 */
export type RawApiKeyAuthenticator<Req extends SecurityRequest = SecurityRequest> = (rawKey: string, req: Req) => Promise<RawApiKeyAuthentication>;
...
export interface ApiKeyAuthConfigCore<Req extends SecurityRequest = SecurityRequest> {
     ...
     */
    onAuthenticated?: (req: Req, key: ApiKeyRecord) => SecurityContext | Promise<SecurityContext>;
    /**
     ...
     */
    onFailure?: (req: Req, reason: ApiKeyFailureReason) => void | Promise<unknown>;
    /**
     ...
     */
    onError?: (req: Req) => ApiKeyErrorResponse | void | Promise<ApiKeyErrorResponse | void>;
}
...
export type ApiKeyFailureReason = 'missing' | 'malformed' | 'bad_prefix' | 'not_found' | 'hash_mismatch' | 'expired' | 'ip_denied' | 'error' | 'unavailable';
