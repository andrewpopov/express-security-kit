...
export type { CanonicalApiKeyRecord, CreateCanonicalRawAuthenticatorOptions, } from './core/api-key/canonicalAuthenticator';
export declare const createCanonicalRawAuthenticator: (options: CreateCanonicalRawAuthenticatorOptions) => RawApiKeyAuthenticator<Request>;
